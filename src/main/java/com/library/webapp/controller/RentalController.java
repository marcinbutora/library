...
public class RentalController {
    ...
    public ResponseEntity<?> saveRental(@PathVariable Long bookId, @PathVariable Long personId, LocalDateTime rentedDate) {
        rentalService.saveNewRental(bookId, personId, rentedDate);
